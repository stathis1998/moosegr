...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "border-l-4 border-l-gray-200 data-[state=open]:border-l-[#15B79E] pl-6",
        className,
      )}
      {...props}
    />
