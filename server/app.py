...
AUTO_REPLY = {
    "en": {
        ...
        "body": (
            ...
            "\n"
            "Want to talk it through? Book a free 30-minute call at a time\n"
            "that suits you: https://calendly.com/moose-info/30min\n"
            "\n"
    ...
    "el": {
        ...
        "body": (
            ...
            "\n"
            "Θέλετε να το συζητήσουμε; Κλείστε μια δωρεάν κλήση 30 λεπτών\n"
            "την ώρα που σας βολεύει: https://calendly.com/moose-info/30min\n"
            "\n"
